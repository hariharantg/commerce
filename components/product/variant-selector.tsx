            ...
            return (
              <button
                ...
                className={clsx(
                  ...
                  {
                    'border-blue-600 ring-2 ring-blue-600 bg-neutral-100 text-black dark:bg-neutral-900 dark:text-black': isActive,
                    'bg-neutral-100 text-neutral-800 border-neutral-300 hover:bg-blue-50 dark:bg-neutral-900 dark:text-neutral-100 dark:border-neutral-700 dark:hover:bg-blue-900': !isActive && isAvailableForSale,
